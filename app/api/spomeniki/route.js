...
const KLJUC = "vsi-spomeniki";
const VERZIJA_KLJUC = "vsi-spomeniki-verzija";
...
export async function GET() {
  try {
    ...
    console.error("Napaka pri branju spomenikov iz Redis:", e);
...
export async function POST(request) {
  try {
    ...
    if (
      ...
      return Response.json(
        { napaka: "Podatki so bili medtem spremenjeni na drugi napravi. Preveri stanje in poskusi znova.", konflikt: true, trenutnaVerzija },
        { status: 409 }
      );
    }
    ...
    console.error("Napaka pri shranjevanju spomenikov v Redis:", e);
