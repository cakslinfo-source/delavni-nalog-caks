...
const KLJUC = "vse-skladisce";
const VERZIJA_KLJUC = "vse-skladisce-verzija";
...
export async function GET() {
  try {
    ...
    console.error("Napaka pri branju skladišča:", e);
...
export async function POST(request) {
  try {
    ...
    console.error("Napaka pri shranjevanju skladišča:", e);
